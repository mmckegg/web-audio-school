...
module.exports = function (audioContext) {
  ...
  return { // eslint-disable-line accessor-pairs
    ...
    setAnswer: function (src) {
      runAnswer = new Function('AudioContext', src) // eslint-disable-line no-new-func
    },

    set: function (src) {
      try {
        run = new Function('AudioContext', src) // eslint-disable-line no-new-func
      } catch (ex) {
        // syntax error
      }
    },
